"""
DocsBot — AI documentation generator from code and Git history
...
class Router:
    """Cost- and latency-aware model router for DocsBot."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="DocsBot: AI documentation generator from code and Git history")
